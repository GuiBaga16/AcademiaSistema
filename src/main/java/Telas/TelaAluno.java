...
public class TelaAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblSapatos);
        ...
        btnExcluir2.setBackground(new java.awt.Color(255, 51, 51));
        ...
        jTabbedPane2.addTab("Cadastro", jTabbedPane3);
    ...
    private void btnExcluir2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluir2ActionPerformed
        int linha = tblSapatos.getSelectedRow();
        int Id = Integer.parseInt(String.valueOf(tblSapatos.getModel().getValueAt(linha, 0)));

        Sapato sapato = sapatosController.recuperaUm(Id);
        if (sapato == null) {
            Mensagem.erro("Sapato não encontrado.");
        } else {
            boolean retorno = sapatosController.excluir(sapato.getId());

            if (retorno) {
                Mensagem.informacao("Sapato " + Id + " apagado com sucesso!");
                carregaInformacoes();
            } else {
                Mensagem.erro("Ocorreu um erro ao tentar excluir o sapato " + Id);
            }
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (sapato == null) {
            ...
            txtModelo.setText(sapato.getModelo());
            txtMarca.setText(sapato.getMarca());
            txtCor.setText(sapato.getCor());
            txtTamanho.setText(String.valueOf(sapato.getTamanho()));
